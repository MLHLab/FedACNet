...
data_dir = pathlib.Path("C:/Users/tapom/Desktop/FullData/USA")
...
# Save model weights
pickle.dump(model.get_weights(), open('Client1_USA.pkl', 'wb'))
...
# Save model weights
pickle.dump(model.get_weights(), open('Client1_USA2.pkl', 'wb'))
...
# Read model weight
weight = pickle.load(open('Client2_China2.pkl', 'rb'))
